...
\begin{figure} [h]
  \centering
  \includegraphics[width=0.45\textwidth]{{Pictures/Asimov_0.100-0.105_TeVmap}.pdf}\\
  \includegraphics[width=0.45\textwidth]{{Pictures/Asimov_0.975-1.040_TeVmap}.pdf}\\
  \includegraphics[width=0.45\textwidth]{{Pictures/Asimov_8.858-10.055_TeVmap}.pdf}
  \caption{\label{fig:asimov} Slices of the Asimov mapcube at 0.100 TeV, 1 TeV and 10 TeV ( \textit{top}, \textit{middle},  and \textit{bottom} respectively) produced with the full emission model of the \gls{lmc} described in section \ref{sec:model}. The four H.E.S.S. point sources are marked with red stars in the 1 TeV map.}
  \end{figure}
