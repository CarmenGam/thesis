...
During the commissioning phase of the \gls{lst} 1, one of the objectives is to test the uniformity of the camera and perform the necessary adjustments of ensure it. The non-uniformity along all the pixels of the camera translate in some pixels or modules to be more probable to trigger than others, biasing the results of the data analysis shown in chapter \ref{cap:LST1}. In orther to have an idea of the uniformity of the camera during the three Crab campaigns, and spot possible problems in the data, the distribution of the centroids of the Hillas ellipses in the camera has been plotted for each day of observation. This way, anisotropies can be observed, pointing to pixels which for some reason which has to be studied, are triggered with a different frequency than the mean. 

\section{Distribution of centroid of Hillas ellipses for standard analysis}
...
\section{Distribution of centroid of Hillas ellipses for Expectation-Maximization analysis}
