{
//=========Macro generated from canvas: Gain mean, Disc 1/Gain mean, Disc 1
//=========  (Mon May 23 16:24:09 2016) by ROOT version5.34/32
   TCanvas *c1 = new TCanvas("Gain mean, Disc 1", "Gain mean, Disc 1",12,155,700,500);
   ...
   TH2F *htemp__1 = new TH2F("htemp__1","Gain mean, Disc 1",40,0,6.6,40,0.818,0.87);
   ...
   htemp__1->GetYaxis()->SetTitle("Gain Mean [mV]");
   htemp__1->GetYaxis()->SetRange(0,41);
   ...
   TPaveText *pt = new TPaveText(0.1934384,0.9367722,0.5042693,0.995,"blNDC");
   pt->SetName("title");
   pt->SetBorderSize(0);
   pt->SetFillColor(0);
   pt->SetFillStyle(0);
   pt->SetTextFont(42);
   TText *text = pt->AddText("Gain mean, Disc 1");
   pt->Draw();
   ...
   graph->SetPoint(0,0,0.8555809855);
   graph->SetPoint(1,1,0.8249310255);
   graph->SetPoint(2,2,0.8668739796);
   graph->SetPoint(3,3,0.8561390042);
   graph->SetPoint(4,4,0.8581719995);
   graph->SetPoint(5,5,0.8550310135);
   graph->SetPoint(6,6,0.8597249985);
   
   TH1F *Graph_Graph1 = new TH1F("Graph_Graph1","Graph",100,0,6.6);
   Graph_Graph1->SetMinimum(0.8162488);
   Graph_Graph1->SetMaximum(0.8710683);
   ...
   Graph_Graph2->SetMinimum(0.8157467);
   Graph_Graph2->SetMaximum(0.8662943);
   ...
   Graph_Graph3->SetMinimum(0.8131512);
   Graph_Graph3->SetMaximum(0.8639928);
