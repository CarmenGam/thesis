...
int ASIC(float THRESHOLD)
{
  ...
  FILE *fp, *fadd, *fcomp, *fphe, *fswitch; // Archivos que genera el programa: las señales de entrada, las salidas de los sumadores y la saluda del comparador. 
